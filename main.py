    ...
    for i in cl1:
        if "Расписание учебных занятий 1 курс с" in i.text:
            ...
            async def send_message_handler(message: types.Message):
                ...
                message_text = "Hello, World!\n Я James, и я буду помогать присылать расписание пар в удобном тебе формате. И если тебе понадобится назначить дежурных на день, то с помощью команды я абсолютно рандомным образом выдам дежурных. Я рад, что мы познакомились!\n(～￣▽￣)～"
